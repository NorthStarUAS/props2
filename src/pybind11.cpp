...
PYBIND11_MODULE(PropertyTree, m) {
    ...
    py::class_<PropertyNode>(m, "PropertyNode")
        ...
        .def("isInt", static_cast<bool (PropertyNode::*)(const char *)>(&PropertyNode::isInt))
        .def("isInt", static_cast<bool (PropertyNode::*)(const char *, unsigned int)>(&PropertyNode::isUInt))
        .def("isUInt", static_cast<bool (PropertyNode::*)(const char *)>(&PropertyNode::isUInt))
        .def("isUInt", static_cast<bool (PropertyNode::*)(const char *, unsigned int)>(&PropertyNode::isUInt))
        .def("isInt64", static_cast<bool (PropertyNode::*)(const char *)>(&PropertyNode::isInt64))
        .def("isInt64", static_cast<bool (PropertyNode::*)(const char *, unsigned int)>(&PropertyNode::isInt64))
        .def("isBool", static_cast<bool (PropertyNode::*)(const char *)>(&PropertyNode::isBool))
        .def("isBool", static_cast<bool (PropertyNode::*)(const char *, unsigned int)>(&PropertyNode::isBool))
        .def("isDouble", static_cast<bool (PropertyNode::*)(const char *)>(&PropertyNode::isDouble))
        .def("isDouble", static_cast<bool (PropertyNode::*)(const char *, unsigned int)>(&PropertyNode::isDouble))
        .def("isString", static_cast<bool (PropertyNode::*)(const char *)>(&PropertyNode::isString))
        .def("isString", static_cast<bool (PropertyNode::*)(const char *, unsigned int)>(&PropertyNode::isString))
